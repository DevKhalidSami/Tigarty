    ...
    $.ajax({
        ...
        for(var i=0; i<msg.invoices.length; i++){
            ...
            var rowIndex = $('#invoices').dataTable().fnAddData([
                ...
                '<button class="btn btn-xs btn-warning showInvoice"   data-target="#showTraderBills" title="تعديل الفاتوره" id="'+singleInvoice[0]+'"><i class="fa fa-pencil"></i></button>&nbsp;' +
