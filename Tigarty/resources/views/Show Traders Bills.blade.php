...
<div id="fadeandscale" class="well" style="background-color: white">
    ...
    {{--<button class="fadeandscale_close btn btn-default">Close</button>--}}
        ...
        <div class="modal fade" id="showTraderBills" tabindex="-1" role="dialog" aria-labelledby="contactLabel" aria-hidden="true" data-backdrop="static"  data-keyboard="false" dir="rtl">
